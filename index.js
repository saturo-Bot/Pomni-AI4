...
const client = new Client({
  phoneNumber: '201225603991', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "247579682029763@lid", jid: "201225603991@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "201225603991@s.whatsapp.net" },
  // Owner 3
